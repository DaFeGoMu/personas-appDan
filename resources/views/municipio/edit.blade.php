...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="{{ route('municipios.update', ['municipio' => $municipio]) }}">
        @method('put')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" required class="form-control" id="muni_nomb" placeholder="Municipality name" name="name" value="{{ $municipio->muni_nomb }}">
        </div>
        <div class="mt-3">
            <label for="departamento" class="form-label">Departamento</label>
            <select class="form-select" id="departamento" name="depa_codi" required>
